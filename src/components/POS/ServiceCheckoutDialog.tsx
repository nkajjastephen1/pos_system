...
export function ServiceCheckoutDialog({
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} title="Complete Payment" maxWidth="md">
            ...
            <div className="flex gap-2 flex-wrap">
              {uniqueQuickAmounts.map(amount => (
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium bg-emerald-100 hover:bg-emerald-200 dark:bg-emerald-900/40 dark:hover:bg-emerald-900/60 text-emerald-700 dark:text-emerald-300 rounded-lg transition-colors"
                >
